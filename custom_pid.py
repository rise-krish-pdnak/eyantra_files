...
class swift():
	...
	def __init__(self):
		...
		##	min and max values for above initialized values
	...
	#	8. Add error_sum
		...
		self.alt_error = - (self.setpoint[2] - self.drone_positon[2])

		self.rcThrottle = 1590 + self.alt_error * self.Kp[2] + (self.alt_error - self.prev_alt_error)* self.Kd[2] + self.sum_alt_error* self.Ki[2]
